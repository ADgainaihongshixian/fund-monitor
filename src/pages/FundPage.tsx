    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-4">
        <Container maxWidth="lg" sx={{ px: { xs: 2, sm: 3, md: 4 } }}>
          ...
          <Card variant="outlined" sx={{ mb: 4, p: 2.5, borderRadius: '0.75rem', borderColor: 'divider' }}>
            <CardContent sx={{ p: 0 }}>
              <div className="flex flex-col gap-3">
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Schedule className="h-4 w-4 text-info" />
          ...
          {error && (
            <Alert
              severity="error"
              icon={<ErrorOutline className="h-5 w-5 text-danger mt-0.5 flex-shrink-0" />}
