...
import { NavbarProps, NavItem } from '@/types/common';
import {
    AppBar,
    Toolbar,
    Typography,
...
import { Menu as MenuIcon, AccountBalance, Diamond, Close as CloseIcon, AccountBalanceWallet } from '@mui/icons-material';
